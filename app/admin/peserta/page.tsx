...
export default async function ParticipantsPage({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  ...
  return <AdminShell activePath="/admin/peserta" title="Peserta" description="Kelola hasil assessment dan pengumuman setiap calon murid secara individual." email={admin.email}>
