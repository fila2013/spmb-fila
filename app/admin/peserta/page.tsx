...
export default async function ParticipantsPage({ searchParams }: { searchParams: Promise<{ q?: string; deleted?: string }> }) {
  ...
  return <AdminShell activePath="/admin/peserta" title="Peserta" description="Kelola assessment, pengumuman, pembayaran DU, link grup, dan konfirmasi WhatsApp setiap calon murid." email={admin.email}>
